...
{
    public class IngredienteRepository : BaseRepository<ReceitaIngrediente>, IIngredienteRepository
    {
        public IngredienteRepository(SqlServerContext context) : base(context)
        {
        }
